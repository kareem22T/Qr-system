            ...
            <form method="POST" action="{{ route('licenses.store') }}">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label class="form-group has-float-label">
                                <input class="form-control" type="date" name="license_starting_date">
                                <span>تاريخ بداية الرخصة</span>
                            </label>
                        </div>
                        <div class="col-md-6">
                            <label class="form-group has-float-label">
                                <input class="form-control" type="date" name="license_ending_date">
                        ...
                        <div class="w-100">
                            <button type="submit" class="btn btn-primary" style="margin: auto">تعين</button>
                        </div>
                    </div>
                </form>
